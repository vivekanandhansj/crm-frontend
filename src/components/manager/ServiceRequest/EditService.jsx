...
const EditService = ({
  ...
  useEffect(() => {
    ...
    const url =
      "https://glacial-castle-08491.herokuapp.com/api/managerdashboard/servicerequest";
  ...
  const editServiceRequest = () => {
    ...
    axios
      .put(
        `https://glacial-castle-08491.herokuapp.com/api/managerdashboard/servicerequest/${id}`,
        response
      )
      .then((res) => {
